...
(function () {
  ...
  document.body.addEventListener('htmx:afterRequest', (e) => {
    ...
    if (e.detail.successful) {
      ...
      // Fire the Meta Lead conversion event, tagged for the preschool ad set.
      // (No-op until PIXEL_ID is set in index.html.)
      if (window.fbq) fbq('track', 'Lead', { content_category: 'preschool' });
    } else {
  ...
  function onScroll() {
    ...
    if (scrolled >= halfway) {
      ...
      if (window.fbq) fbq('trackCustom', 'ScrollDepth50', { content_category: 'preschool' });
    }
  }
